...
bank_df$educationNum = as.numeric(factor(bank_df$education,                                         levels=c("unknown","illiterate","basic.4y","basic.6y","basic.9y"
          ,"high.school",
...
bank_lr_aic_int = glm(y ~ (contact + month + duration + campaign 
                           + poutcome + cons.conf.idx + nr.employed+contact:month+campaign:poutcome)
