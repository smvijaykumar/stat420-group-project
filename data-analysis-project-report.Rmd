...
compare <- data.frame(Method = c('Logistic Regression (cutoff = 0.1)', 'Random Forest (mtry = 5)', 'Adaptive boosting'), Accuracy = NA, Sensitivity = NA, Specificity = NA, Precision = NA, Recall = NA, FScore = NA, 'ROC AUC' = NA)
